...
// This script fixes all three major issues
...
(function() {
    ...
    function loadTemplates() {
        ...
        const templates = [
            {
                name: 'Common Cold',
                symptoms: 'Runny nose, sneezing, mild fever, sore throat, body ache',
                medicines: 'Paracetamol 500mg (1-0-1), Cetirizine 10mg (0-0-1), Vitamin C (1-0-0)'
            },
            {
                name: 'Fever & Body Pain',
                symptoms: 'High fever (102°F), severe body pain, headache, weakness',
                medicines: 'Paracetamol 650mg (1-1-1), Ibuprofen 400mg (1-0-1), Rest and hydration'
            },
            {
                name: 'Gastric Problem',
                symptoms: 'Acidity, stomach pain, bloating, indigestion',
                medicines: 'Pantoprazole 40mg (1-0-0), Domperidone 10mg (1-0-1), Antacid syrup (2 tsp after meals)'
            },
            {
                name: 'Cough & Cold',
                symptoms: 'Persistent cough, chest congestion, mild fever, throat irritation',
                medicines: 'Ambroxol 30mg (1-1-1), Cetirizine 10mg (0-0-1), Cough syrup (2 tsp TDS)'
            },
            {
                name: 'Headache & Migraine',
                symptoms: 'Severe headache, sensitivity to light, nausea',
                medicines: 'Paracetamol 500mg (1-0-1), Sumatriptan 50mg (SOS), Rest in dark room'
            },
            {
                name: 'Allergic Reaction',
                symptoms: 'Skin rash, itching, redness, mild swelling',
                medicines: 'Cetirizine 10mg (1-0-1), Calamine lotion (apply TDS), Avoid allergen'
            }
        ];
    ...
    function ensureApiKey() {
        ...
        if (!apiKey || apiKey === '') {
            console.warn('⚠️ No API key found, using default...');
            // This will be set by config-loader.js
            return false;
        }
